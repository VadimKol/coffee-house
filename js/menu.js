...
export function CreateModal (item, products, element) {
    ...
    for(let product of products){
        ...
        if (type !== null && type.innerText === product.name) {
            let src = item.querySelector(".grid-" + product.category + "-item-box__pic").src;
            ...
            modal_item_info_list_s__btn.classList.add("modal-item-info-list-s__btn--active");
            ...
            modal_item_info_total__price.classList.add("modal-item-info-total__price");
            ...
            modal_item_info_alert.append("The cost is not final. Download our mobile app to see the final price and place your order. Earn loyalty points and enjoy your favorite coffee with up to 20% discount.");
